...
class Training(models.Model):
    training_plan = models.ForeignKey(TrainingPlan, on_delete=models.CASCADE, related_name="trainings")
    fitness_exercise = models.IntegerField(verbose_name=_("training__fitness_exercise"))
    days_of_week = models.CharField(max_length=100, verbose_name=_("training__days_of_week"))
